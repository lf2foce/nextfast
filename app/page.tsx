...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6">
            ...
            <textarea
                className="w-full max-w-2xl p-4 border rounded bg-gray-800 text-white"
                rows="6"
            ...
            />
            <button
                className="mt-4 p-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold"
            ...
            {response && (
                <div className="mt-6 w-full max-w-2xl border p-6 rounded bg-gray-800">
